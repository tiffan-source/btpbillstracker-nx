...
import { BillRepository, CreateEnrichedBillUseCase, DeleteBillPdfUseCase, DocumentRepository, EditBillUseCase, GetAllUserConnectedBillsUseCase, GetBillPdfUrlUseCase, PayMyBillUseCase, UploadBillPdfUseCase } from "@btpbilltracker/bills";
...
export const BILL_PROVIDERS: Provider[] = [
    ...
    {provide: GetBillPdfUrlUseCase, useFactory: (billRepo: BillRepository, docRepo: DocumentRepository, currentUser: AuthProvider) => new GetBillPdfUrlUseCase(billRepo, docRepo, currentUser), deps: [BillRepository, DocumentRepository, AuthProvider]},
]
