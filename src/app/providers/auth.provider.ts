...
import { AuthProvider, GetCurrentUserUseCase, LoginWithEmailAndPasswordUseCase, LogoutUseCase, RegisterWithEmailAndPasswordUseCase } from "@btpbilltracker/auth";
...
export const AUTH_PROVIDERS: Provider[] = [
    ...
    {provide: LogoutUseCase, useFactory: (authProvider: AuthProvider) => new LogoutUseCase(authProvider), deps: [AuthProvider]}
]