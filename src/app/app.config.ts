...
import { envAppConfig } from '../env/env';
import { AUTH_PROVIDERS } from './providers/auth.provider';
import { REMINDER_PROVIDERS } from './providers/reminder.provider';
import { provideSupabase } from './providers/supabase.provider';

export function provideAppConfig(): ApplicationConfig {
  return {
    providers: [
      provideBrowserGlobalErrorListeners(),
      ...
      ...provideFirebase(envAppConfig.firebase),
      ...provideSupabase(envAppConfig.supabase),
      ...CLIENT_PROVIDERS,
      ...CHANTIER_PROVIDERS,
      ...BILL_PROVIDERS,
      ...AUTH_PROVIDERS,
